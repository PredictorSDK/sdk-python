...
class MarketDetailFeeLeg(UniversalBaseModel):
    """
    ...
    model: MarketDetailFeeLegModel = pydantic.Field()
    """
    ...
    exponent: typing.Optional[float] = pydantic.Field(default=None)
    """
    ...
    rounding: typing.Optional[MarketDetailFeeRounding] = None
